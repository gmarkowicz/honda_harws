<div id="tabs">
    ...
    <form autocomplete="off" enctype="multipart/form-data" method="post" action="<?php echo current_url();?>">
        <ul>	
            <fieldset>
                <legend><?=$this->marvin->mysql_field_to_human('upload_title');?></legend>
                    <li class="unitx4 f-left">
                        <?php
                            $config	= array(
                                'field_name'  =>'upload_file_field_desc',
                                'field_req'	  =>TRUE,
		...
		<fieldset>
                    ...
                    <?php
                        ...
                        if(isset($upload_file_adjunto) && count($upload_file_adjunto)>0)
                        {
                                $config['adjuntos'] = $upload_file_adjunto;
                        }
