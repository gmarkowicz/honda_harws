...
<form autocomplete="off" enctype="multipart/form-data" method="post" action="<?php echo current_url();?>">
		...
		<ul>	
				...
				<li class="unitx4 f-left">
					...
					<?php
						$config	=	array(
							'field_name'		=>'libro_servicio_estado_field_desc',
							'field_req'			=>TRUE,
		...
		*/
		...
		<?php
			...
			$config['model'] = strtolower($this->model);
			if(isset($libro_servicio_estado_adjunto) && count($libro_servicio_estado_adjunto)>0)
			{
				$config['adjuntos'] = $libro_servicio_estado_adjunto;
			}
