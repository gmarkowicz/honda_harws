...
<?endif?>
	...
	<div id="tabs">
		...
		<div id="tabs-1">
			...
			<?php if(isset($_SESSION['nos_listado']['registros_encontrados'])):?>
				<div class="botones_registros">
					<p><a id="versionimprenta" href="<?php echo current_url();?>/vprint" target="blank"><?=lang('imprimir');?></a></p>	
				</div>
			<?php endif;?>
			...
			<?php
				if(isset($_SESSION['nos_listado']))
				{
					...
					{
			?>	
					<p class="fr"><strong><?php echo $_SESSION['nos_listado']['registros_encontrados'];?> registros encontrados</strong></p>
	...
	<div id="tabs-2">
		...
		<li class="unitx4 f-left">
			<?php
					$config	=	array(
							'field_name'=>'encuesta_nos_field_fechahora_alta_inicial',
							'field_req'=>FALSE,
				...
				<?php
					$config	=	array(
							'field_name'=>'encuesta_nos_field_fechahora_alta_final',
							'field_req'=>FALSE,
