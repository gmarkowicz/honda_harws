...
<form autocomplete="off" enctype="multipart/form-data" method="post" action="<?php echo current_url();?>">
		...
		<li class="unitx4 f-left">
			<?php
						$config	=	array(
							'field_name'		=>'reclamo_garantia_estado_field_desc',
							'field_req'		=>TRUE,
		...
		*/
		...
		<?php
			...
			$config['model'] = strtolower($this->model);
			if(isset($reclamo_garantia_estado_adjunto) && count($reclamo_garantia_estado_adjunto)>0)
			{
				$config['adjuntos'] = $reclamo_garantia_estado_adjunto;
			}
