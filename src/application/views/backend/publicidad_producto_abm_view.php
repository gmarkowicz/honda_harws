...
<form autocomplete="off" enctype="multipart/form-data" method="post" action="<?php echo current_url();?>">
		...
		<ul>	
				...
				<li class="unitx4 f-left">
					...
					<?php
						$config	=	array(
							'field_name'		=>'publicidad_producto_field_desc',
							'field_req'		=>TRUE,
		...
		*/
		...
		<?php
			...
			$config['model'] = strtolower($this->model);
			if(isset($publicidad_producto_adjunto) && count($publicidad_producto_adjunto)>0)
			{
				$config['adjuntos'] = $publicidad_producto_adjunto;
			}
