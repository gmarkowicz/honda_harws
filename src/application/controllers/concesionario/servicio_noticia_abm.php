...
class Servicio_Noticia_Abm extends Backend_Controller{
	...
	public function add()
	{
		...
		{		
			if ($this->_validar_formulario() == TRUE)
			{
				...
				$this->registro_actual = new Servicio_Noticia();
	...
	private function _grabar_registro_actual()
	{
		try
		{
			...
			*/
			$this->registro_actual->servicio_noticia_field_titulo = $this->input->post('servicio_noticia_field_titulo');
			$this->registro_actual->servicio_noticia_field_fecha = $this->input->post('servicio_noticia_field_fecha');
