...
*/
define('ID_SECCION',6017);
class Boutique_Disponibilidad_Abm extends Backend_Controller{
	...
	public function add()
	{
		if($this->input->post('_submit'))
		{
			...
			{				
				...
				$this->registro_actual = new Boutique_Disponibilidad();
	...
	private function _grabar_registro_actual()
	{
		try
		{
			...
			$this->registro_actual->boutique_disponibilidad_field_desc = $this->input->post('boutique_disponibilidad_field_desc');
	...
	private function _validar_formulario() {
		...
		$this->form_validation->set_rules('boutique_disponibilidad_field_desc',$this->marvin->mysql_field_to_human('boutique_disponibilidad_field_desc'),
