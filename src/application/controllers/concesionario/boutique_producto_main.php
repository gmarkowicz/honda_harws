...
class Boutique_Producto_Main extends Backend_Controller {
		...
		'_buscador_general'=>
			...
			array(
					...
					'rules'			=>'grid|sorteable|export|print|align[left]|width[200]|print|',
                        ...
                        'boutique_producto_estado_field_desc'=>
                                    array(
					'sql_filter'	=>FALSE,
					'grid'			=>TRUE,
					'width'			=>70,
	...
	function Boutique_Producto_Main()
	{
	...
	private function _validar_filtros() {
		...
		$this->form_validation->set_rules('boutique_producto_field_desc',$this->marvin->mysql_field_to_human('boutique_producto_field_desc'),
			'trim'
		);
