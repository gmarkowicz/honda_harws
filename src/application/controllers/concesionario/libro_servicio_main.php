...
class Libro_Servicio_Main extends Backend_Controller {
	...
	var $default_valid_fields = array(
		...
		'_buscador_general'=>
			array(
					'sql_filter'	=>array('MATCH( 
												unidad_field_vin,
												unidad_field_unidad,
												libro_servicio_field_propietario_nombre,
												libro_servicio_field_propietario_apellido,
												libro_servicio_field_propietario_razon_social
		...
		'libro_servicio_field_kilometros'=>
			array(
		...
		'libro_servicio_field_motivo_requerimiento'=>
			array(
				 'sql_filter'	=>array('MATCH( %THIS% ) against (? IN BOOLEAN MODE)'),
				 'grid'			=>FALSE,
				 'width'		=>100,
				 ...
				 'download'  	=>FALSE,
				 'print'  		=>TRUE,
				 'rules'		=>'sorteable|export|print|align[left]|width[100]|print|',
				 
			),

		'libro_servicio_field_observaciones'=>
			array(
				 'sql_filter'	=>array('MATCH( %THIS% ) against (? IN BOOLEAN MODE)'),
				 'grid'			=>FALSE,
				 'width'		=>100,
		...
		'libro_servicio_estado_field_desc'=>
			array(
				 'sql_filter'	=>FALSE,
				 'grid'			=>TRUE,
				 'width'		=>100,
		...
		'libro_servicio_field_fechahora_alta'=>
			array(
				 'sql_filter'	=>FALSE,
				 'grid'			=>TRUE,
				 'width'		=>100,
		...
		'libro_servicio_field_fechahora_alta_inicial'=>
			array(
				 'sql_filter'	=>array('DATE(libro_servicio_field_fechahora_alta) >= ?'),
				 'grid'			=>FALSE,
				 'width'		=>FALSE,
				 'sorteable'	=>FALSE,
				 'align'		=>FALSE,
		...
		'libro_servicio_field_fechahora_alta_final'=>
			array(
				 'sql_filter'	=>array('DATE(libro_servicio_field_fechahora_alta) >= ?'),
				 'grid'			=>FALSE,
				 'width'		=>FALSE,
...
*/
	...
	private function _validar_filtros() {		
		...
		$this->form_validation->set_rules('libro_servicio_field_fechahora_alta_inicial',$this->marvin->mysql_field_to_human('libro_servicio_field_fechahora_alta_inicial'),
			'trim|my_form_date_reverse'
		);
		$this->form_validation->set_rules('libro_servicio_field_fechahora_alta_final',$this->marvin->mysql_field_to_human('libro_servicio_field_fechahora_alta_final'),
			'trim|my_form_date_reverse'
		);
		$this->form_validation->set_rules('libro_servicio_field_fechahora_alta',$this->marvin->mysql_field_to_human('libro_servicio_field_fechahora_alta'),
			'trim|my_form_date_reverse'
		);
