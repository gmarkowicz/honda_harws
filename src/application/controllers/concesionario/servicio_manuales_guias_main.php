<?php
define('ID_SECCION',3032);

class Servicio_Manuales_Guias_Main extends Backend_Controller {
	...
	var $default_valid_fields = array(
		...
		'_buscador_general'=>
			array(
				'sql_filter'	=>array('MATCH( 
												servicio_manuales_guias_field_titulo
		...
		'servicio_manuales_guias_field_fecha'=>
			array(
				 'sql_filter'	=>FALSE,
				 'grid'			=>TRUE,
				 'width'		=>80,
		...
		'servicio_manuales_guias_field_fecha_inicial'=>
			array(
				 'sql_filter'	=>array('DATE(servicio_manuales_guias_field_fecha) >= ?'),
				 'grid'			=>FALSE,
				 'width'		=>FALSE,
				 'sorteable'	=>FALSE,
				 'align'		=>FALSE,
		...
		'servicio_manuales_guias_field_fecha_final'=>
			array(
				 'sql_filter'	=>array('DATE(servicio_manuales_guias_field_fecha) >= ?'),
				 'grid'			=>FALSE,
				 'width'		=>FALSE,
	...
	function Servicio_Manuales_Guias_Main()
	{
	...
	private function _validar_filtros() {		
		...
		// validation rules
		$this->form_validation->set_rules('servicio_manuales_guias_field_titulo',$this->marvin->mysql_field_to_human('servicio_manuales_guias_field_titulo'),
			'trim'
		);
		$this->form_validation->set_rules('servicio_manuales_guias_field_fecha_inicial',$this->marvin->mysql_field_to_human('servicio_manuales_guias_field_fecha_inicial'),
			'trim|my_form_date_reverse'
		);
		$this->form_validation->set_rules('servicio_manuales_guias_field_fecha_final',$this->marvin->mysql_field_to_human('servicio_manuales_guias_field_fecha_final'),
			'trim|my_form_date_reverse'
		);
		$this->form_validation->set_rules('servicio_manuales_guias_field_fecha',$this->marvin->mysql_field_to_human('servicio_manuales_guias_field_fecha'),
			'trim|my_form_date_reverse'
		);
