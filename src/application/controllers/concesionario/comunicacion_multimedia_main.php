...
class Comunicacion_Multimedia_Main extends Backend_Controller {
	...
	var $default_valid_fields = array(
		...
		'_buscador_general'=>
			array(
				'sql_filter'	=>array(
										'MATCH(
												comunicacion_multimedia_field_desc
		...
		'comunicacion_multimedia_field_desc'=>
			...
			'comunicacion_multimedia_tipo_field_desc'=>
			array(
				 'sql_filter'	=> false,
				 'grid'			=>true,
				 'width'		=>200,
			...
			'comunicacion_multimedia_tipo_id'=>
			array(
					'sql_filter'	=> array('%THIS%'),
					'grid'			=>false,
					'width'		=>100,
