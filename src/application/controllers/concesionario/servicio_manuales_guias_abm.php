...
class Servicio_Manuales_Guias_Abm extends Backend_Controller{
	...
	public function add()
	{
		...
		{		
			if ($this->_validar_formulario() == TRUE)
			{
				...
				$this->registro_actual = new Servicio_Manuales_Guias();
	...
	private function _grabar_registro_actual()
	{
		try
		{
			...
			*/
			$this->registro_actual->servicio_manuales_guias_field_titulo = $this->input->post('servicio_manuales_guias_field_titulo');
			$this->registro_actual->servicio_manuales_guias_field_fecha = $this->input->post('servicio_manuales_guias_field_fecha');
