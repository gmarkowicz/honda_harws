<?php
define('ID_SECCION',1033);
class Pais_abm extends Backend_Controller{
	...
	private function _grabar_registro_actual()
	{
		try
		{
			...
			*/
			$this->registro_actual->pais_field_desc = $this->input->post('pais_field_desc');
	...
	private function _validar_formulario() {
		...
		$this->form_validation->set_rules('pais_field_desc',$this->marvin->mysql_field_to_human('pais_field_desc'),
				'trim|max_length[255]|required|my_unique_db[Pais.pais_field_desc '.$id.']	' );
