...
class Reclamo_Garantia_Estado_Main extends Backend_Controller {
...
/*		
		//para descargar
		'reclamo_garantia_estado_adjunto'=>
			array(
				 'sql_filter'	=>FALSE,
				 'grid'			=>TRUE,
				 'width'		=>100,
...
*/
	...
	function Reclamo_Garantia_Estado_Main()
	{
	...
	private function _validar_filtros() {		
		...
		$this->form_validation->set_rules('_field_id',$this->marvin->mysql_field_to_human('id'),
			'trim'
		);
