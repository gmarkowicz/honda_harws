...
class Servicio_Circular_Abm extends Backend_Controller{
	...
	public function add()
	{
		...
		{		
			if ($this->_validar_formulario() == TRUE)
			{
				...
				$this->registro_actual = new Servicio_Circular();
	...
	private function _grabar_registro_actual()
	{
		try
		{
			...
			*/
			$this->registro_actual->servicio_circular_field_titulo = $this->input->post('servicio_circular_field_titulo');
			$this->registro_actual->servicio_circular_field_fecha = $this->input->post('servicio_circular_field_fecha');
			$this->registro_actual->servicio_circular_categoria_id = $this->input->post('servicio_circular_categoria_id');
	...
	private function _validar_formulario() {
		...
		$this->form_validation->set_rules('servicio_circular_field_titulo',$this->marvin->mysql_field_to_human('servicio_circular_field_titulo'),
				'trim|max_length[255]|required|min_lenght[6]' );
