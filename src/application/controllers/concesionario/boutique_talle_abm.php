...
*/
define('ID_SECCION',6016);

class Boutique_Talle_Abm extends Backend_Controller{
	...
	public function add()
	{
		if($this->input->post('_submit'))
		{
			...
			{				
				...
				$this->registro_actual = new Boutique_Talle();
	...
	private function _grabar_registro_actual()
	{
		try
		{
			...
			$this->registro_actual->boutique_talle_field_desc = $this->input->post('boutique_talle_field_desc');
	...
	private function _validar_formulario() {
		...
		$this->form_validation->set_rules('boutique_talle_field_desc',$this->marvin->mysql_field_to_human('boutique_talle_field_desc'),
