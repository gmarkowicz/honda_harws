...
class Material_Precio_Fob_Main extends Backend_Controller {
	...
	var $default_valid_fields = array(
		...
		'_buscador_general'=>
			array(
				'sql_filter'	=>array(
										...
										'MATCH( 
												material_field_desc, material_id
		...
		'moneda_field_desc'=>
			...
			'material_precio_fob_field_precio_fob'=>
			array(
				 'sql_filter'	=>array('%THIS% >= ?'),
				 'grid'			=>TRUE,
				 'width'		=>100,
...
*/
	...
	function Material_Precio_Fob_Main()
	{
