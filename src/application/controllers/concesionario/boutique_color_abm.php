...
*/
define('ID_SECCION',6015);
class Boutique_Color_Abm extends Backend_Controller{
	...
	public function add()
	{
		if($this->input->post('_submit'))
		{
			...
			{				
				...
				$this->registro_actual = new Boutique_Color();
		...
		try {
			...
			{				
				...
				{					
					...
					$this->del_adjunto($this->registro_actual->id, $subfix );				
	...
	private function _grabar_registro_actual()
	{
		try
		{
			...
			$this->registro_actual->boutique_color_field_desc = $this->input->post('boutique_color_field_desc');
	...
	private function _validar_formulario() {
		...
		$this->form_validation->set_rules('boutique_color_field_desc',$this->marvin->mysql_field_to_human('boutique_color_field_desc'),
