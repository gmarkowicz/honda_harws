<?php
define('ID_SECCION',3033);

class Servicio_Reporte_Tecnico_Rth_Main extends Backend_Controller {
	...
	var $default_valid_fields = array(
		...
		'_buscador_general'=>
			array(
				'sql_filter'	=>array('MATCH( 
												servicio_reporte_tecnico_rth_field_titulo
		...
		'servicio_reporte_tecnico_rth_field_titulo'=>
			array(
				 ...
				 'export'		=>TRUE,
				 'download'   => FALSE,
				 'params'		=>'grid|sorteable|export|align-left|width-100|',
				 
			),

		'servicio_reporte_tecnico_rth_field_fecha'=>
			array(
				 'sql_filter'	=>FALSE,
				 'grid'			=>TRUE,
				 'width'		=>100,
		...
		'servicio_reporte_tecnico_rth_field_fecha_inicial'=>
			array(
				 'sql_filter'	=>array('DATE(servicio_reporte_tecnico_rth_field_fecha) >= ?'),
				 'grid'			=>FALSE,
				 'width'		=>FALSE,
				 'sorteable'	=>FALSE,
				 'align'		=>FALSE,
		...
		'servicio_reporte_tecnico_rth_field_fecha_final'=>
			array(
				 'sql_filter'	=>array('DATE(servicio_reporte_tecnico_rth_field_fecha) >= ?'),
				 'grid'			=>FALSE,
				 'width'		=>FALSE,
	...
	function Servicio_Reporte_Tecnico_Rth_Main()
	{
	...
	private function _validar_filtros() {		
		...
		$this->form_validation->set_rules('servicio_reporte_tecnico_rth_field_titulo',$this->marvin->mysql_field_to_human('servicio_reporte_tecnico_rth_field_titulo'),
			'trim'
		);
		$this->form_validation->set_rules('servicio_reporte_tecnico_rth_field_fecha_inicial',$this->marvin->mysql_field_to_human('servicio_reporte_tecnico_rth_field_fecha_inicial'),
			'trim|my_form_date_reverse'
		);
		$this->form_validation->set_rules('servicio_reporte_tecnico_rth_field_fecha_final',$this->marvin->mysql_field_to_human('servicio_reporte_tecnico_rth_field_fecha_final'),
			'trim|my_form_date_reverse'
		);
		$this->form_validation->set_rules('servicio_reporte_tecnico_rth_field_fecha',$this->marvin->mysql_field_to_human('servicio_reporte_tecnico_rth_field_fecha'),
			'trim|my_form_date_reverse'
		);
