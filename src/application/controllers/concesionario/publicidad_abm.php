...
class Publicidad_Abm extends Backend_Controller{
	...
	var $upload_image = array('imagen','imagen_medio');
	...
	public function add()
	{
		...
		{		
			if ($this->_validar_formulario() == TRUE)
			{
				...
				$this->registro_actual = new Publicidad();
	...
	public function show($id = FALSE)
	{
		...
		$this->load->view('backend/publicidad_abm_show_view',$this->template);
	}
	...
	private function _grabar_registro_actual()
	{
		try
		{
			...
			{
				$this->registro_actual->publicidad_field_admin_alta_id = $this->session->userdata('admin_id');
				$this->registro_actual->publicidad_field_fechahora_alta = date('Y-m-d H:i:s', time());
			}
			else if($this->router->method == 'edit' )
			{
				$this->registro_actual->publicidad_field_admin_modifica_id = $this->session->userdata('admin_id');
				$this->registro_actual->publicidad_field_fechahora_modificacion = date('Y-m-d H:i:s', time());
			}
			*/
			$this->registro_actual->publicidad_field_desc = $this->input->post('publicidad_field_desc');
			$this->registro_actual->publicidad_field_fecha_publicacion = $this->input->post('publicidad_field_fecha_publicacion');
			$this->registro_actual->publicidad_medida_id = $this->input->post('publicidad_medida_id');
			$this->registro_actual->publicidad_ubicacion_id = $this->input->post('publicidad_ubicacion_id');
			$this->registro_actual->publicidad_medio_id = $this->input->post('publicidad_medio_id');
			$this->registro_actual->publicidad_producto_id = $this->input->post('publicidad_producto_id');
