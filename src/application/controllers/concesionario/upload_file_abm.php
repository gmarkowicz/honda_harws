...
class Upload_File_Abm extends Backend_Controller{
	...
	public function add()
	{
            if($this->input->post('_submit'))
            {
                ...
                {                             
                    ...
                    $this->registro_actual = new Upload_File();
	...
	private function _grabar_registro_actual()
	{
		try
		{
			...
			$this->registro_actual->upload_file_field_desc = $this->input->post('upload_file_field_desc');
