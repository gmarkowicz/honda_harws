<?php
define('ID_SECCION',3037);

class Servicio_Noticia_Main extends Backend_Controller {
	...
	var $default_valid_fields = array(
		...
		'servicio_noticia_field_fecha_inicial'=>
			array(
				 'sql_filter'	=>array('DATE(servicio_noticia_field_fecha) >= ?'),
				 'grid'			=>FALSE,
				 'width'		=>FALSE,
				 'sorteable'	=>FALSE,
				 'align'		=>FALSE,
		...
		'servicio_noticia_field_fecha_final'=>
			array(
				 'sql_filter'	=>array('DATE(servicio_noticia_field_fecha) >= ?'),
				 'grid'			=>FALSE,
				 'width'		=>FALSE,
	...
	function Servicio_Noticia_Main()
	{
	...
	private function _validar_filtros() {		
		...
		$this->form_validation->set_rules('servicio_noticia_field_titulo',$this->marvin->mysql_field_to_human('servicio_noticia_field_titulo'),
			'trim'
		);
		$this->form_validation->set_rules('servicio_noticia_field_fecha_inicial',$this->marvin->mysql_field_to_human('servicio_noticia_field_fecha_inicial'),
			'trim|my_form_date_reverse'
		);
		$this->form_validation->set_rules('servicio_noticia_field_fecha_final',$this->marvin->mysql_field_to_human('servicio_noticia_field_fecha_final'),
			'trim|my_form_date_reverse'
		);
		$this->form_validation->set_rules('servicio_noticia_field_fecha',$this->marvin->mysql_field_to_human('servicio_noticia_field_fecha'),
			'trim|my_form_date_reverse'
		);
