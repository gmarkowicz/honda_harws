...
class Boutique_Pedido_Estado_Abm extends Backend_Controller{
	...
	public function add()
	{
		if($this->input->post('_submit'))
		{
			...
			{				
				...
				$this->registro_actual = new Boutique_Pedido_Estado();
	...
	private function _grabar_registro_actual()
	{
		try
		{
			...
			$this->registro_actual->boutique_pedido_estado_field_desc = $this->input->post('boutique_pedido_estado_field_desc');
