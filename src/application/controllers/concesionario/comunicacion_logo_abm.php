...
class Comunicacion_Logo_Abm extends Backend_Controller{
	...
	public function add()
	{
		if($this->input->post('_submit'))
		{
			if ($this->_validar_formulario() == TRUE)
			{
				...
				$this->registro_actual = new Comunicacion_Logo();
	...
	private function _grabar_registro_actual()
	{
		try
		{
			...
			{
				$this->registro_actual->comunicacion_logo_field_admin_alta_id = $this->session->userdata('admin_id');
				$this->registro_actual->comunicacion_logo_field_fechahora_alta = date('Y-m-d H:i:s', time());
			}
			else if($this->router->method == 'edit' )
			{
				$this->registro_actual->comunicacion_logo_field_admin_modifica_id = $this->session->userdata('admin_id');
				$this->registro_actual->comunicacion_logo_field_fechahora_modificacion = date('Y-m-d H:i:s', time());
			}

			$this->registro_actual->comunicacion_logo_field_desc = $this->input->post('comunicacion_logo_field_desc');
	...
	private function _view()
	{
		...
		$this->template['comunicacion_logo_imagen'] = $this->registro_actual ? $this->registro_actual->Comunicacion_Logo_Imagen : array();

		$this->template['comunicacion_logo_adjunto'] = $this->registro_actual ? $this->registro_actual->Comunicacion_Logo_Adjunto : array();
