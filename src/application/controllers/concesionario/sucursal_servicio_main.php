...
class Sucursal_Servicio_Main extends Backend_Controller {
	...
	var $default_valid_fields = array(
		...
		'_buscador_general'=>
			array(
				'sql_filter'	=>array(
										...
										'MATCH( 
												sucursal_servicio_field_desc,
												sucursal_servicio_field_direccion,
												sucursal_servicio_field_codigo_postal,
												sucursal_servicio_field_telefono
		...
		'sucursal_servicio_field_pagina_web'=>
			array(
				 'sql_filter'	=>array('MATCH( %THIS% ) against (? IN BOOLEAN MODE)'),
				 'grid'			=>TRUE,
				 'width'		=>100,
...
*/
	...
	function Sucursal_Servicio_Main()
	{
