...
class Servicio_Boletin_Main extends Backend_Controller {
	...
	var $default_valid_fields = array(
		...
		//solo para reporte
		'servicio_boletin_field_fecha_inicial'=>
			array(
				'sql_filter'	=>array('servicio_boletin_field_fecha >= ?'),
				 'grid'			=>FALSE,
				 'width'		=>100,
				 'sorteable'	=>FALSE,
				 'align'		=>'left',
		...
		//solo para reporte
		'servicio_boletin_field_fecha_final'=>
			array(
				 'sql_filter'	=>array('servicio_boletin_field_fecha <= ?'),
				 'grid'			=>FALSE,
				 'width'		=>100,
		...
		'servicio_boletin_categoria_field_desc'=>
			array(
				 'sql_filter'	=>FALSE,
				 'grid'			=>TRUE,
				 'width'		=>150,
	...
	function Servicio_Boletin_Main()
	{
	...
	private function _validar_filtros() {		
		...
		$this->form_validation->set_rules('servicio_boletin_field_fecha_inicial',$this->marvin->mysql_field_to_human('servicio_boletin_field_fecha_inicial'),
			'trim|my_form_date_reverse'
		);
		$this->form_validation->set_rules('servicio_boletin_field_fecha_final',$this->marvin->mysql_field_to_human('servicio_boletin_field_fecha_final'),
			'trim|my_form_date_reverse'
		);
