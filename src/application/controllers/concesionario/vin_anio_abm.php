...
*/
define('ID_SECCION',1061);
class Vin_Anio_abm extends Backend_Controller{
	...
	public function add()
	{
		...
		{		
			if ($this->_validar_formulario() == TRUE)
			{
				...
				$this->registro_actual = new Vin_Anio();
	...
	private function _validar_formulario() {
		...
		$this->form_validation->set_rules('id',$this->marvin->mysql_field_to_human('id'),
				'trim|exact_length[1]|required|my_unique_db[Vin_Anio.id '.$id.']' );
