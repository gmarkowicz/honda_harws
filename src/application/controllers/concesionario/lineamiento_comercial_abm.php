...
class Lineamiento_Comercial_Abm extends Backend_Controller{
	...
	public function add()
	{
		...
		{		
			if ($this->_validar_formulario() == TRUE)
			{
				...
				$this->registro_actual = new Lineamiento_Comercial();
	...
	private function _grabar_registro_actual()
	{
		try
		{
			...
			{
				$this->registro_actual->lineamiento_comercial_field_admin_alta_id = $this->session->userdata('admin_id');
				$this->registro_actual->lineamiento_comercial_field_fechahora_alta = date('Y-m-d H:i:s', time());
			}
			else if($this->router->method == 'edit' )
			{
				$this->registro_actual->lineamiento_comercial_field_admin_modifica_id = $this->session->userdata('admin_id');
				$this->registro_actual->lineamiento_comercial_field_fechahora_modificacion = date('Y-m-d H:i:s', time());
			}
			*/
			$this->registro_actual->lineamiento_comercial_field_desc = $this->input->post('lineamiento_comercial_field_desc');
