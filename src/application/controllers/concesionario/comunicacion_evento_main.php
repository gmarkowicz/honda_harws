...
class Comunicacion_Evento_Main extends Backend_Controller {
	...
	var $default_valid_fields = array(
		...
		'_buscador_general'=>
			array(
				'sql_filter'	=>array(
										'MATCH(
												comunicacion_evento_field_desc
		...
		'comunicacion_evento_field_desc'=>
			...
			'comunicacion_evento_field_fecha'=>
			array(
				 'sql_filter'	=>false,
				 'grid'			=>true,
				 'width'		=>100,
			...
			'fecha_inicial'=>
			array(
					'sql_filter'	=>array('comunicacion_evento_field_fecha >= ?'),
					'grid'			=>FALSE,
					'width'		=>100,
					'sorteable'	=>FALSE,
					'align'		=>'left',
	...
	private function _validar_filtros() {
		...
		$this->form_validation->set_rules('fecha_inicial',$this->marvin->mysql_field_to_human('fecha_inicial'),
				'trim|my_form_date_reverse'
		);
		$this->form_validation->set_rules('fecha_final',$this->marvin->mysql_field_to_human('fecha_final'),
				'trim|my_form_date_reverse'
		);
