...
class Vin_Version_main extends Backend_Controller {
	//filtra por sucursal?
	var $sucursal = FALSE;
	...
	private function _view()
	{
		...
		$q->orderBy('auto_modelo_field_desc ASC');
		$q->addOrderBy('auto_version_field_desc ASC');
