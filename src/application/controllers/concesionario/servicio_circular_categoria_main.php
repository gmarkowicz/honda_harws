...
class Servicio_Circular_Categoria_Main extends Backend_Controller {
	...
	var $default_valid_fields = array(
		...
		'servicio_circular_categoria_field_desc'=>
			array(
				 ...
				 'export'		=>TRUE,
				 'download'  	 => FALSE,
				 'rules'		=>'grid|sorteable|export|align[left]|width[100]|',
				 
			),
		);
			
			
	function Servicio_Circular_Categoria_Main()
	{
