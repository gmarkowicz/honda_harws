...
class Hma_Abm extends Backend_Controller{
...
public function del()
    ...
    private function _grabar_registro_actual()
    {
        try
        {
            ...
            $this->registro_actual->hma_field_desc = $this->input->post('hma_field_desc');
    ...
    private function _view()
    {
        ...
        $this->_view_adjunto(); //muestro archivos adjuntos (si los hay); //definida $this->$hma_adjunto = array();
    ...
    private function _validar_formulario() {
        ...
        $this->form_validation->set_rules('hma_field_desc',$this->marvin->mysql_field_to_human('hma_field_desc'), 'trim|max_length[255]|required' );
