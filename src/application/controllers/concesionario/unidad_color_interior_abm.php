<?php
define('ID_SECCION',1024);
class Unidad_Color_Interior_abm extends Backend_Controller{
	...
	public function add()
	{
		...
		{		
			if ($this->_validar_formulario() == TRUE)
			{
				...
				$this->registro_actual = new Unidad_Color_Interior();
	...
	private function _grabar_registro_actual()
	{
		try
		{
			...
			*/
			...
			$this->registro_actual->unidad_color_interior_field_desc = $this->input->post('unidad_color_interior_field_desc');
	...
	private function _validar_formulario() {
		...
		$this->form_validation->set_rules('id',$this->marvin->mysql_field_to_human('id'),
				'trim|max_length[30]|required|my_unique_db[Unidad_Color_Interior.id '.$id.']' );

		
		$this->form_validation->set_rules('unidad_color_interior_field_desc',$this->marvin->mysql_field_to_human('unidad_color_interior_field_desc'),
				'trim|max_length[255]|required|my_unique_db[Unidad_Color_Interior.unidad_color_interior_field_desc '.$id.']' );
