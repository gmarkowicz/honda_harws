...
class Codigo_Radio_Solicitud_Abm extends Backend_Controller{
	...
	public function add()
	{
		...
		{		
			if ($this->_validar_formulario() == TRUE)
			{
				...
				$this->registro_actual = new Codigo_Radio_Solicitud();
	...
	private function _grabar_registro_actual()
	{
		try
		{
			...
			{
				$this->registro_actual->codigo_radio_solicitud_field_admin_alta_id = $this->session->userdata('admin_id');
				$this->registro_actual->codigo_radio_solicitud_field_fechahora_alta = date('Y-m-d H:i:s', time());
				$this->registro_actual->unidad_id = $unidad->id;
				$this->registro_actual->codigo_radio_solicitud_estado_id = 1; //pendiente
			}
			else if($this->router->method == 'edit' )
			{
				$this->registro_actual->codigo_radio_solicitud_field_admin_modifica_id = $this->session->userdata('admin_id');
				$this->registro_actual->codigo_radio_solicitud_field_fechahora_modificacion = date('Y-m-d H:i:s', time());
				if($this->backend->_permiso('admin'))
				{
					$this->registro_actual->codigo_radio_solicitud_field_resultado = $this->input->post('codigo_radio_solicitud_field_resultado');
					$this->registro_actual->codigo_radio_solicitud_estado_id = $this->input->post('codigo_radio_solicitud_estado_id');
				}
			}
			
			$this->registro_actual->codigo_radio_solicitud_field_numero_serial = $this->input->post('codigo_radio_solicitud_field_numero_serial');
			$this->registro_actual->codigo_radio_solicitud_field_numero_parte = $this->input->post('codigo_radio_solicitud_field_numero_parte');
			$this->registro_actual->codigo_radio_solicitud_field_numero_referencia = $this->input->post('codigo_radio_solicitud_field_numero_referencia');
			$this->registro_actual->codigo_radio_solicitud_field_observaciones = $this->input->post('codigo_radio_solicitud_field_observaciones');
	...
	private function _validar_formulario() {
		...
		$this->form_validation->set_rules('codigo_radio_solicitud_field_observaciones',$this->marvin->mysql_field_to_human('codigo_radio_solicitud_field_observaciones'),
				'trim|max_length[2500]' );

		$this->form_validation->set_rules('codigo_radio_solicitud_field_resultado',$this->marvin->mysql_field_to_human('codigo_radio_solicitud_field_resultado'),
				'trim|max_length[100]' );
