...
class Servicio_Reporte_Tecnico_Rth_Abm extends Backend_Controller{
	...
	public function add()
	{
		...
		{		
			if ($this->_validar_formulario() == TRUE)
			{
				...
				$this->registro_actual = new Servicio_Reporte_Tecnico_Rth();
	...
	private function _grabar_registro_actual()
	{
		try
		{
			...
			*/
			$this->registro_actual->servicio_reporte_tecnico_rth_field_titulo = $this->input->post('servicio_reporte_tecnico_rth_field_titulo');
			$this->registro_actual->servicio_reporte_tecnico_rth_field_fecha = $this->input->post('servicio_reporte_tecnico_rth_field_fecha');
