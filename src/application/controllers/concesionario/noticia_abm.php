...
class Noticia_abm extends Backend_Controller{
	...
	private function _grabar_registro_actual()
	{
		...
		try
		{
			...
			{
				$this->registro_actual->noticia_field_admin_alta_id = $this->session->userdata('admin_id');
			}
			else if($this->router->method == 'edit' )
			{
				$this->registro_actual->noticia_field_admin_modifica_id = $this->session->userdata('admin_id');
			}
	...
	private function _view()
	{
		...
		$this->_view_image(); //muestro imagenes (si las hay);
