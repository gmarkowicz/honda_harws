...
class Boutique_Disponibilidad_Main extends Backend_Controller {
	...
	var $default_valid_fields = array(
		...
		'_buscador_general'=>
			array(
				'sql_filter'	=>array(
										...
										'MATCH(
												boutique_disponibilidad_field_desc
		...
		'boutique_disponibilidad_field_desc'=>
			array(
				 ...
				 'download'  	=>FALSE,
				 'print'  		=>TRUE,
				 'rules'		=>'grid|sorteable|export|print|align[left]|width[800]|print|',
	...
	function Boutique_Disponibilidad_Main()
	{
