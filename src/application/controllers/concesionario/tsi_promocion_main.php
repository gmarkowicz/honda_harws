...
class Tsi_Promocion_Main extends Backend_Controller {
	...
	var $default_valid_fields = array(
		...
		'tsi_promocion_field_fecha_inicio'=>
			array(
				 'sql_filter'	=>FALSE,
				 'grid'			=>TRUE,
				 'width'		=>100,
