...
class Boutique_Talle_Main extends Backend_Controller {
	...
	private function _validar_filtros() {
		...
		$this->form_validation->set_rules('boutique_talle_field_desc',$this->marvin->mysql_field_to_human('boutique_color_field_desc'),
			'trim'
		);
